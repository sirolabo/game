...
window.onload = function() {
  ...
  game = require("game");
  return game.core.start("#viewport");
};



}).call(this,typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"game":10}],2:[function(require,module,exports){
module.exports = {
  obj: require("./lib/obj"),
...
},{"./lib/core":12}],11:[function(require,module,exports){
...
exports.start = function(divName) {
  var editor;
  if (debug) {
    data.layer["debug"] = new Layer({
      name: "debug"
    });
    return editor = require("../systemEditor");
  }
};
...
exports.title = function() {
  var titleInputCtr;
  return titleInputCtr = function(input) {
...
exports.inputCtr = function(process, callback) {
...
},{"../systemEditor":17,"./config":11,"./data":13,"core":2}],13:[function(require,module,exports){
...
exports.imgPath = "src/img/imageList/";
...
var core, data, gameData, getHaederID, objSelect, setData, setObjData, updateView, web;
...
exports.update = function() {
  var key, param, _ref, _results;
  _ref = gameData.layer["debug"].obj;
  _results = [];
  for (key in _ref) {
    param = _ref[key];
    objSelect = key;
    _results.push(setData());
  }
  return _results;
};
...
setData = function(target) {
  ...
  core.obj.allCall(target.temp, {
    key: "setGuiVal",
    arg: []
  });
  return console.log(project.layers);
};

setObjData = function(id, val) {
  var headerID, idList, index, key, param, target, targetData, _i, _len, _ref;
  ...
  if (idList.indexOf("all") === -1) {
    ...
    _ref = core.obj.parallelLoop(targetData, idList, idList.indexOf("all"));
    for (index in _ref) {
      param = _ref[index];
      param.val = val;
      param.setGuiVal();
  ...
  return updateView(headerID);
};

updateView = function(headerID) {

  /*
    util
   */
  var colorList, getVal, objData;
  ...
  switch (headerID) {
    ...
    case data.obj.name:
      ...
      if (data.gui_obj.rectangle.height.val) {
        objData.height = data.gui_obj.rectangle.height.val;
      }
      objData.color = colorList.base.normal;
      objData.clear();
      return objData.setColor();
  }
};

core.obj.allCall(data.layer.temp, {
  key: "initEvent",
  arg: [
    {
      method: setObjData,
...
core.obj.allCall(data.obj.temp, {
  key: "initEvent",
  arg: [
    {
      method: setObjData,
...
$("#objID_input, #layerID_input").bind('change', (function(_this) {
  return function(e) {
    var headerID;
    headerID = e.currentTarget.id.split("_")[0];
    console.log(headerID);
    switch (headerID) {
      case data.layer.name + "ID":
        data.layer.selected = e.currentTarget.value;
        return setData(data.layer);
      case data.obj.name + "ID":
...
},{"../lib/data":13,"./data":16,"core":2,"web":21}],16:[function(require,module,exports){
var core, create, data, deleteData, getHaederID, initDefine, io, layerObj, load, save, setID, setObjID, socketIO, web;
...
setObjID = (function(_this) {
  return function(param) {
    $("#objID_input").val(param.id);
    return $("#objID_input").trigger("change");
  };
})(this);

setID = function(headerID, guiObj) {
    ...
    for (key in argParam) {
      ...
      if (!param.name) {
        ...
        if (param.name === "unitSlider" || param.name === "color") {
          ...
          _results.push(param.id = headerID + "_" + id);
        }
      }
    }
    return _results;
...
initDefine = function(define) {
  core.obj.allCall(define.gui, {
    key: "init",
    arg: []
  });
  core.obj.allDelete(define.gui, "init");
  setID(define.name, define.gui);
  return core.obj.setMapVal(define.temp, [], define.gui);
};
...
io.on('systemEditor_load_end', (function(_this) {
  return function(loadData) {
    var ctr, key, param, _ref;
    _ref = loadData.layerObj;
    for (key in _ref) {
      param = _ref[key];
      data.layer["debug"].obj[key] = new layerObj.layerObj(param);
      data.layer["debug"].obj[key].initEvent(setObjID);
    }
    _this.gui_objData = loadData.gui_objData;
    ctr = require("./ctr");
    return ctr.update();
  };
})(this));
...
save = (function(_this) {
  return function(param) {
    var headerID, makeSaveData, saveData;
    ...
    return io.emit('systemEditor_save', JSON.stringify(makeSaveData()));
  };
})(this);

load = (function(_this) {
  return function(param) {
    return io.emit('systemEditor_load');
  };
})(this);
...
create = (function(_this) {
  return function(param) {
    ...
    switch (headerID) {
      case _this.layer.name:
        data.layer[id] = new Layer({
          name: id
        });
    }
    core.obj.setMapVal(_this[headerID].data, [[id]], _this[headerID].gui);
    $("#" + headerID + "ID_input").val(id);
    return $("#" + headerID + "ID_input").trigger("change");
  };
})(this);

deleteData = (function(_this) {
  return function(param) {
    var id;
    id = $("#objID_input").val();
    data.layer["debug"].obj[id].clear();
    delete data.layer["debug"].obj[id];
    return delete _this.gui_objData[id];
  };
})(this);
...
exports.layer = {
  ...
  gui: {
    file: {
      init: function() {
        this.id = new web.gui.input({
          event: false
        });
        this.save = new web.gui.button({
          text: "save",
          callback: save
        });
        this.load = new web.gui.button({
          text: "load",
          callback: load
        });
        this.create = new web.gui.button({
          text: "create",
          callback: create
        });
        return this["delete"] = new web.gui.button({
          text: "delete",
          callback: deleteData
        });
      }
...
exports.obj = {
  ...
  gui: {
    ...
    color: {
      init: function() {
        return this.colorPicker = new web.gui.colorPicker({});
      }
    },
    rectangle: {
      init: function() {
        this.width = new web.gui.slider({
          param: {
            max: 1920
          }
        });
        return this.height = new web.gui.slider({
          param: {
            max: 1080
          }
        });
    ...
    image: {
      init: function() {
        return this.fileName = new web.gui.selectBox({
    ...
    text: {
      init: function() {
        return this.text = new web.gui.input;
      }
    }
  }
};

initDefine(this.layer);
...
},{"../lib/data":13,"../lib/layerObj":14,"./ctr":15,"core":2,"socket.io-client":28,"web":21}],17:[function(require,module,exports){
var ctr_css;
...
},{"./ctr":15,"./data":16,"event/com":9}],18:[function(require,module,exports){
module.exports = {
  core: require('./lib/core'),
  dom: require('./lib/dom')
};
...
},{"./lib/color":22,"./lib/core":23,"./lib/data":24,"./lib/gui":25,"./lib/size":26,"./lib/url":27}],22:[function(require,module,exports){
...
},{"./color":22,"core":2,"html":18}],26:[function(require,module,exports){
...
},{"./manager":30,"./socket":32,"./url":33,"debug":36,"socket.io-parser":67}],30:[function(require,module,exports){
...
},{"./on":31,"./socket":32,"./url":33,"component-bind":34,"component-emitter":35,"debug":36,"engine.io-client":37,"object-component":64,"socket.io-parser":67}],31:[function(require,module,exports){
...
},{"./on":31,"component-bind":34,"component-emitter":35,"debug":36,"has-binary":61,"indexof":63,"socket.io-parser":67,"to-array":71}],33:[function(require,module,exports){
(function (global){
...
},{"debug":36,"parseuri":65}],34:[function(require,module,exports){
/**
 * Slice reference.
 */
...
},{"./socket":39,"engine.io-parser":48}],39:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./transport":40,"./transports":41,"component-emitter":35,"debug":36,"engine.io-parser":48,"indexof":63,"parsejson":57,"parseqs":58,"parseuri":59}],40:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":35,"engine.io-parser":48}],41:[function(require,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling":44,"component-emitter":35,"component-inherit":47,"debug":36,"xmlhttprequest":46}],44:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":40,"component-inherit":47,"debug":36,"engine.io-parser":48,"parseqs":58,"xmlhttprequest":46}],45:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":40,"component-inherit":47,"debug":36,"engine.io-parser":48,"parseqs":58,"ws":60}],46:[function(require,module,exports){
...
},{"has-cors":55}],47:[function(require,module,exports){
...
},{"./binary":66,"./is-buffer":68,"component-emitter":35,"debug":36,"isarray":69,"json3":70}],68:[function(require,module,exports){
(function (global){
